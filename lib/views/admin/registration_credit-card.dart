...
class RegistrationCreditCard extends StatefulWidget {
  const RegistrationCreditCard({super.key});

  @override
  State<RegistrationCreditCard> createState() => _RegistrationCreditCardState();
}

class _RegistrationCreditCardState extends State<RegistrationCreditCard> {
  @override
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: const Align(
                        ...
                        child: AutoSizeText(
                          "Aprovação de Cadastro de Cartão",
                          maxLines: 1,
                          minFontSize: 10,
                          style: TextStyle(
                            fontSize: 20,
